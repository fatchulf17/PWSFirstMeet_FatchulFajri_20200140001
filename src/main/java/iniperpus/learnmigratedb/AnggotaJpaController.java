 ...
 */
package iniperpus.learnmigratedb;

import iniperpus.learnmigratedb.exceptions.IllegalOrphanException;
import iniperpus.learnmigratedb.exceptions.NonexistentEntityException;
import iniperpus.learnmigratedb.exceptions.PreexistingEntityException;
...
public class AnggotaJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("iniperpus_learnmigratedb_jar_0.0.1-SNAPSHOTPU");

    public EntityManager getEntityManager() {
        return emf.createEntityManager();
    }

    public AnggotaJpaController() {
    }
